...
PEOPLE SEARCH RESULTS (candidates for best first contact — note: last names may be partially masked by Apollo, that is expected):
...
Based on this data, respond with ONLY a raw JSON object, no markdown fences, no commentary, in exactly this shape:
{
  ...
  "vertical_reasoning": string (one short phrase explaining the vertical call),
